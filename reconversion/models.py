...
class ReconversionEntrepriseCommerciale(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.mot_de_passe == self.beneficiaire.mdp:
            ...
            compte_grenier.prelevement_reconversion += self.montant_a_prelever
            compte_grenier.save()
            ...
            self.montant_virer_sur_compte_conso = (self.epounds_a_reconvertir - self.montant_a_prelever) * 0.15
            ...
            # transfert des 80% sur le compte grenier
            compte_grenier.prelevement_vendeur += (self.epounds_a_reconvertir - self.montant_a_prelever) * 0.8
            compte_grenier.save()
            # mise a jour du compte de l'entreprise
            compte_entreprise_commercial.save()
            # sauvegarde du montant cfa retourner
            self.montant_en_cfa = (self.epounds_a_reconvertir - self.montant_a_prelever) * 0.8
